    ...
    <Layout>
      ...
      >
        <section className={styles.events}>
          ...
          <iframe
            src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ftheofficebarsd&tabs=events&width=340&height=244&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
            style={{ border: "none" }}
            scrolling="no"
            frameborder="0"
            ...
            width="340"
            height="244"
            title="Events at The Office Bar"
          />
